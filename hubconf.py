...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from utils_.general import LOGGER, check_requirements, intersect_dicts, logging
    from utils_.torch_utils import select_device
...
if __name__ == '__main__':
    ...
    from utils_.general import cv2, print_args
